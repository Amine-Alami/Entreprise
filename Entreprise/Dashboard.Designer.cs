namespace Entreprise
{
	partial class Dashboard
	{
		...
		private void InitializeComponent()
		{
			...
			this.fraisUserControl1 = new Entreprise.FraisUserControl();
			this.dateUserControl1 = new Entreprise.DateUserControl();
			...
			this.bunifuFlatButton2.ButtonText = "        Frais de stages par date             ";
			...
			this.bunifuFlatButton2.Size = new System.Drawing.Size(298, 57);
			this.bunifuFlatButton2.TabIndex = 4;
			this.bunifuFlatButton2.Text = "        Frais de stages par date             ";
			...
			this.bunifuFlatButton2.MouseLeave += new System.EventHandler(this.bunifuFlatButton2_MouseLeave);
			...
			this.bunifuFlatButton1.ButtonText = "Analyse de frais de stages             ";
			...
			this.bunifuFlatButton1.Size = new System.Drawing.Size(298, 57);
			this.bunifuFlatButton1.TabIndex = 3;
			this.bunifuFlatButton1.Text = "Analyse de frais de stages             ";
			...
			// fraisUserControl1
			// 
			this.fraisUserControl1.AutoScroll = true;
			this.fraisUserControl1.Location = new System.Drawing.Point(138, 147);
			this.fraisUserControl1.Name = "fraisUserControl1";
			this.fraisUserControl1.Size = new System.Drawing.Size(1067, 538);
			this.fraisUserControl1.TabIndex = 7;
			// 
			// dateUserControl1
			// 
			this.dateUserControl1.AutoScroll = true;
			this.dateUserControl1.Location = new System.Drawing.Point(138, 147);
			this.dateUserControl1.Name = "dateUserControl1";
			this.dateUserControl1.Size = new System.Drawing.Size(1067, 538);
			this.dateUserControl1.TabIndex = 8;
			// 
			// Dashboard
			// 
			...
			this.Controls.Add(this.fraisUserControl1);
		...
		private FraisUserControl fraisUserControl1;
